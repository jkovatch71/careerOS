...
export function OutreachForm({ opportunities, contacts, outreach }: {
  ...
  return <form action={formAction} className="space-y-5">
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="space-y-2"><Label htmlFor="sent_at">Sent at</Label><DateTimeInput id="sent_at" name="sent_at" defaultValue={dateTimeValue(outreach?.sent_at ?? null)} /></div>
      <div className="space-y-2"><Label htmlFor="response_at">Response at</Label><DateTimeInput id="response_at" name="response_at" defaultValue={dateTimeValue(outreach?.response_at ?? null)} /></div>
