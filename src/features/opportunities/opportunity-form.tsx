...
import type { Company, Opportunity } from "@/lib/supabase/database.types";
    ...
    <form action={formAction} className="space-y-8">
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-2 sm:col-span-2">
          ...
          <textarea id="notes" name="notes" rows={6} defaultValue={opportunity?.notes ?? ""} className="w-full resize-y rounded-md border border-input bg-transparent px-3 py-2 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring/30" />
        </div>
      </div>
